...
class Fab {
    ...
    static $comandos = array(
        ...
        'db_createtables' => 'Create tables with schema [schema.yml]',
        'db_make' => 'Drop and Create data base and its tables [schema.yml]',
        'db_populate' => 'Truncate and populate tables with the fixtures [fixtures.yml] -f (no truncate)',
    ...
    static function interpreta($argv) {
        ...
        switch ($argv[1]) {
            ...
            case 'db_populate':
                ...
                $truncate = ($argv[3] != '-t');
                $result = self::populateDb($argv[2], $truncate);
                self::printResult($result);
                break;
    ...
    static function createTables($schemaFile) {
